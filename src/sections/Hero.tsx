...
export const Hero = () => {
        ...
        <div className="grid w-full gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          >
            ...
            <h1 className="max-w-4xl text-2xl font-semibold leading-tight text-white sm:text-3xl lg:text-4xl">
              <span className="block">A Showcase of My</span>
              <span className="block">Technical Journey, Projects, and Aspirations.</span>
            </h1>
  ...
  cgpa: 8.04,
  mission: "Build intelligent software solutions that solve real-world problems"
